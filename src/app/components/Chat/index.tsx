...
const Chat: React.FC<Chat> = ({
  ...
  return (
    <div id="chat" className="flex flex-col w-full lg:w-3/5 mr-4 mx-5 lg:mx-0">
      ...
      <>
        <form onSubmit={handleMessageSubmit} className="mt-5 mb-5 relative bg-gray-700 rounded-lg">
          <input
            type="text"
          ...
          <span className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-gray-400">Press ⮐ to send</span>
        </form>
      </>
    </div>
  );
